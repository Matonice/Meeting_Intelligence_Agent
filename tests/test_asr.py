...
class TestASREngine:
    ...
    def test_transcribe_returns_segments(self, mock_whisper_cls, asr_config, sample_audio):
        words = [
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_transcribe_multiple_segments(self, mock_whisper_cls, asr_config, sample_audio):
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_transcribe_no_words(self, mock_whisper_cls, asr_config, sample_audio):
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_transcribe_empty_result(self, mock_whisper_cls, asr_config, sample_audio):
        mock_info = _make_mock_info()
        mock_model = MagicMock()
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_language_autodetection(self, mock_whisper_cls, asr_config, sample_audio):
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_model_loaded_once(self, mock_whisper_cls, asr_config, sample_audio):
        mock_info = _make_mock_info()
        mock_model = MagicMock()
        mock_model.transcribe.return_value = ([], mock_info)
        mock_whisper_cls.return_value = mock_model
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_transcribe_passes_config(self, mock_whisper_cls, asr_config, sample_audio):
        mock_info = _make_mock_info()
        mock_model = MagicMock()
        mock_model.transcribe.return_value = ([], mock_info)
        mock_whisper_cls.return_value = mock_model
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_transcribe_segment_returns_text(self, mock_whisper_cls, asr_config, sample_audio):
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_transcribe_segment_zero_length_returns_none(self, mock_whisper_cls, asr_config):
    ...
    @patch("meeting_intelligence.transcription.asr.WhisperModel")
    def test_confidence_from_avg_logprob(self, mock_whisper_cls, asr_config, sample_audio):
